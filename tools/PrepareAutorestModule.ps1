...
$SKIP_MODULES = @("Aks", "AppService", "Billing", "Compute", "ContainerInstance", "ConnectedMachine", "ContainerRegistry", "Dns", "DnsResolver", "Functions", "KeyVault", "Media", "Monitor", "Network", "Resources", "ServiceBus", "Storage")
