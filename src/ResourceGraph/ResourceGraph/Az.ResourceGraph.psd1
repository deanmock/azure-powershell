...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed the output print issue for ''Search-AzGraph'' by updating the output type to Microsoft.Azure.Commands.ResourceGraph.Models.PSResourceGraphResponse''1[[System.Management.Automation.PSObject]].
